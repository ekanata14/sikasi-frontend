      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            ...
            <FormItem>
              {/* @ts-ignore */}
              <FormLabel className={cn("flex justify-between")}>Password <Link href={"/forgot-password"} className={cn("text-blue-600 cursor-pointer")}>lupa password</Link></FormLabel>
              {/* @ts-ignore */}
              <FormControl>
        ...
        <div className="grid gap-2">
          {/* @ts-ignore */}
          <Button className={cn("w-full bg-blue-600 hover:bg-blue-400")}>Simpan</Button>
          {/* Divide Line */}
          ...
          {/* Sign in Google */}
          {/* @ts-ignore */}
          <Button asChild className="w-full bg-blue-600 hover:bg-blue-400 shadow-md gap-2 pl-2">

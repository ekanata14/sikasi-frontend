    ...
    <section className="overflow-x-hidden h-screen flex flex-col lg:grid lg:grid-cols-2">
      ...
      <div className="max-w-80 m-auto py-10 lg:py-0 grid gap-4 relative z-10 lg:order-2 min-h-fit max-h-screen">
        ...
        <form className="flex flex-col gap-4">
          <div>
            <Input type="text" name="nim" placeholder="Ketikan NIM" required inputMode="numeric" />
          </div>
          <div>
            <Input type="text" name="name" placeholder="Ketikan Nama Lengkap" required />
          </div>
          <Select>
            ...
            <SelectContent>
              <SelectItem value="Sistem Informasi">S1 Sistem Informasi</SelectItem>
              <SelectItem value="Teknologi Informasi">S1 Teknologi Informasi</SelectItem>
              <SelectItem value="Sistem Komputer">S1 Sistem Komputer</SelectItem>
              <SelectItem value="Bisnis Digital">S1 Bisnis Digital</SelectItem>
              <SelectItem value="Manajemen Informatika">D3 Manajemen Informatika</SelectItem>
            </SelectContent>
          </Select>
          <div>

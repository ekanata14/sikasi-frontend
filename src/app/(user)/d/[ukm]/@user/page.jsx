import { CreditCard, DollarSign, Megaphone } from "lucide-react";
...
export default function UkmPage() {
  const ActivitiesCard = Data.ukm.activities.map((activities) => (
    <Card
      key={activities.id}
      className={"p-4 min-w-56 max-w-56 border text-slate-800 text-center snap-start "}
    >
      <svg
        className={"w-full"}
      ...
      <section className={cn("mt-4")}>
        <div className={cn("pb-4 px-4 mb-4")}>
          ...
          <Alert className="mt-2">
            ...
            <AlertDescription>
              Terdapat <Badge className={"mx-2"}>3</Badge> kegiatan yang akan dilaksanakan mendatang.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <div className={"grid grid-cols-1 lg:grid-cols-2 gap-2 mb-6"}>
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">total kewajiban anda yang belum dilunaskan</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">total kas ukm berdasarkan kas bulanan anggota</p>
            </CardContent>
          </Card>
        </div>

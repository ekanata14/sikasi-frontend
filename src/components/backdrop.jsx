...
const Backdrop = () => {
    return (
        <div className={cn("relative w-full overflow-hidden h-[10rem] block", "lg:h-full lg:hidden")}>
            <svg className={cn("absolute opacity-25 top-0  right-0 -left-[8%] w-[120%] m-auto", "lg:bottom-0 lg:rotate-90 lg:w-[200%] lg:right-auto lg:-left-[80%]")} viewBox="0 0 602 350" fill="none" xmlns="http://www.w3.org/2000/svg">
